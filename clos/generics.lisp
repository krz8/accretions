;;;; generic function offered in the top level of Accretions

(eval-when (:compile-toplevel)
  (print "compiling clos/generics"))
(eval-when (:load-toplevel)
  (print "loading clos/generics"))
(eval-when (:execute)
  (print "executing clos/generics"))

(defpackage :accretions/clos/generics
  (:use :common-lisp)
  (:export #:make ; #:copy #:add #:size #:mapfun #:emptyp
	   ))
(in-package :accretions/clos/generics)
