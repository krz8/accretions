...
structures, such as ternary search tries, used in various applications
that aren't present in the Common Lisp standard.  Some of these are
provided by various CL implementations, certainly, but they cannot be
relied upon to exist everywhere by portable software.  Accretions
seeks to address that situation, providing solid implementations of
these data structures and their related algorithms."
  ...
  ;; packages, like bag, are NOT exported from the Accretions package
  ...
  ;; package, in turn, expects that others (e.g., bag.lisp) is already
  ;; available in the Lisp environment.  Thus, we list bag.lisp here
  ...
  :depends-on (:accretions/bag :accretions/all)
