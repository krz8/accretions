(defpackage :accretions/src/generics
  (:use :common-lisp)
  (:export #:add #:size #:containsp #:copy #:del #:emptyp #:mapfun))
...
(defgeneric containsp (collection &key &allow-other-keys)
  ...
  perform some operation on one or more matches, consider the function
  MAPFUN; CONTAINSP is just a shortcut for a common idiom."))
